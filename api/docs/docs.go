...
var doc = `{
    ...
    "paths": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CompanyCreateResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CompanyProjectCreateRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/models.CompanyProject"
                                        }
                                    }
                                }
                            ]
        ...
        "/v1/project": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/project_service.GetAllProjectsResponse"
                                        }
                                    }
                                }
                            ]
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "CreateProjectResponseBody",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/http.Response"
    ...
    "definitions": {
        ...
        "models.CompanyProjectCreateRequest": {
            "type": "object",
            "properties": {
                "company_id": {
                    "type": "string"
        ...
        "project_service.GetAllProjectsResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
                ...
                "projects": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/project_service.Project"
                    }
                }
            }
        },
