...
func SetUpAPI(r *gin.Engine, h handlers.Handler, cfg config.BaseConfig, tracer opentracing.Tracer, tracker *apilimits.Tracker) {
	...
	facebook.Use(h.V1.AuthMiddleware(cfg))
	{
		...
		facebook.PUT("/pipeline-mappings/:page_id", h.V1.SaveFacebookPagePipelineMapping)
		...
		facebook.GET("/lead-attribution", h.V1.FacebookLeadAttribution)
		facebook.POST("/crm-form-ids", h.V1.FacebookSaveCRMFormIDs)
	...
	metaAds.Use(tracker.ApiCallCountMiddleware())
	{
		...
		metaAds.GET("/campaigns", h.V1.WorkspaceMetaAdsCampaigns)
		metaAds.GET("/pipeline-campaigns", h.V1.WorkspaceMetaAdsPipelineCampaigns)
		metaAds.PUT("/pipeline-campaigns", h.V1.SaveWorkspaceMetaAdsPipelineCampaigns)
	}
