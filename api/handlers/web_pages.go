...
// @Success 200 {object} http.Response{data=models.GetAllFieldsResponse} "WebPageBody"
// @Response 400 {object} http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} http.Response{data=string} "Server Error"
...
// @Produce json
// @Param guid path string true "guid"
// @Param web page body models.CreateWebPageRequest  true "UpdateWebPageRequestBody"
// @Success 200 {object} http.Response{data=models.WebPage} "WebPage data"
// @Response 400 {object} http.Response{data=string} "Bad Request"
// @Failure 500 {object} http.Response{data=string} "Server Error"
