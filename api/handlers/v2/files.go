...
// DeleteFileByPath godoc
// @Security ApiKeyAuth
// @ID v2_delete_file_by_path
// @Router /v2/files/{path} [DELETE]
// @Summary Delete file by path
// @Description Delete file by path
// @Tags V2Files
// @Accept json
// @Produce json
// @Param id path string true "bucket"
// @Param id path string true "path"
// @Success 204
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV2) DeleteFileByPath(c *gin.Context) {
	path := c.Param("path")
	if path == "" {
		h.handleResponse(c, status_http.BadRequest, "path is empty")
		return
	}
