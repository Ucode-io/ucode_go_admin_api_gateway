...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetSingleUserTemplate(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateUserTemplate(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteUserTemplate(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
	userPermissionId := c.Param("user-permission-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetListUserTemplate(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) CreateSharingToken(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateSharingToken(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetObjectToken(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
