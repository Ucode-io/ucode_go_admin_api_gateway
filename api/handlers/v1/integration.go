...
func (h *HandlerV1) CreateIntegration(c *gin.Context) {
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetIntegrationList(c *gin.Context) {
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetIntegrationSessions(c *gin.Context) {
	// namespace := c.GetString("namespace")
	// services, err := h.GetService(namespace)
	// if err != nil {
	// 	h.handleResponse(c, status_http.Forbidden, err)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) AddSessionToIntegration(c *gin.Context) {
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetIntegrationByID(c *gin.Context) {
	IntegrationID := c.Param("integration-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteIntegration(c *gin.Context) {
	IntegrationID := c.Param("integration-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetIntegrationToken(c *gin.Context) {
	integrationID := c.Param("integration-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) RemoveSessionFromIntegration(c *gin.Context) {
	integrationID := c.Param("integration-id")
	sessionID := c.Param("session-id")
