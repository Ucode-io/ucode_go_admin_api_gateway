...
func (h *HandlerV1) CreateQuery(c *gin.Context) {
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetQueryByID(c *gin.Context) {
	namespace := c.GetString("namespace")
	services, err := h.GetService(namespace)
	if err != nil {
		h.handleResponse(c, status_http.Forbidden, err)
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetQueryList(c *gin.Context) {
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateQuery(c *gin.Context) {
	var query models.CreateQueryRequest
	guid := c.Param("guid")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteQuery(c *gin.Context) {
