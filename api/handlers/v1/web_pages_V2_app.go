...
func (h *HandlerV1) CreateWebPageApp(c *gin.Context) {
	var (
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetSingleWebPageApp(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateWebPageApp(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteWebPageApp(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
	appId := c.Param("webpage-app-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetListWebPageApp(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
