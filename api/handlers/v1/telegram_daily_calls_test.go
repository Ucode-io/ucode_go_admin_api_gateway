...
func TestTelegramCallMetricsForDayDeduplicatesAndCountsTalkTime(t *testing.T) {
	...
	rows := []map[string]any{
		{"call_uuid": "one", "client_phone": "+998 90 123 45 67", "started_at": "2026-09-25T10:00:00+05:00", "duration": 0, "status": "initiated", "direction": "incoming"},
		{"call_uuid": "one", "client_phone": "+998901234567", "started_at": "2026-09-25T10:00:00+05:00", "duration": 120, "status": "answered", "direction": "incoming"},
	...
	if got.Total != 3 || got.Inbound != 1 || got.Outbound != 2 || got.Answered != 2 || got.Leads != 1 || got.Seconds != 180 {
