...
func (h *HandlerV1) facebookCampaignAllowed(ctx context.Context, resource *pb.ProjectResource, pipeline, adID string) (bool, error) {
	...
	campaignID, err := h.facebookAdCampaignID(ctx, resource, adID)
	if err != nil {
		return false, err
	}
...
func (h *HandlerV1) facebookAdCampaignID(ctx context.Context, resource *pb.ProjectResource, adID string) (string, error) {
