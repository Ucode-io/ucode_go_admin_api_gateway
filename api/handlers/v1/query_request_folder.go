...
func (h *HandlerV1) CreateQueryRequestFolder(c *gin.Context) {
	var (
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetSingleQueryRequestFolder(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateQueryRequestFolder(c *gin.Context) {
	var (
		//resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteQueryRequestFolder(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
	folderId := c.Param("query-folder-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetListQueryRequestFolder(c *gin.Context) {
	var (
	//resourceEnvironment *obs.ResourceEnvironment
	)
