...
func (h *HandlerV1) CreateNoteFolder(c *gin.Context) {
	var (
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetSingleNoteFolder(c *gin.Context) {
	var (
	//// resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateNoteFolder(c *gin.Context) {
	var (
		// resourceEnvironment *obs.ResourceEnvironment
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteNoteFolder(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetListNoteFolder(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetNoteFolderCommits(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
...
func (h *HandlerV1) CreateNote(c *gin.Context) {
	...
	_, err = services.GetBuilderServiceByType(resource.NodeType).Menu().Create(
		context.Background(),
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetSingleNote(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
...
func (h *HandlerV1) GetSingleNoteWithoutToken(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
	noteId := c.Param("note-id")
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetListNote(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetNoteCommits(c *gin.Context) {
	var (
	// resourceEnvironment *obs.ResourceEnvironment
	)
