...
func (h *HandlerV1) CreateQueryFolder(c *gin.Context) {
...
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetQueryFolderByID(c *gin.Context) {
	...
	resp, err := services.BuilderService().QueryFolder().GetById(
		context.Background(),
		&obs.QueryFolderId{
			Id:        c.Param("guid"),
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) GetQueryFolderList(c *gin.Context) {
...
// @Response 400 {object} status_http.Response{data=string} "Bad Request"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) UpdateQueryFolder(c *gin.Context) {
	var queryFolder models.CreateQueryFolderRequest
	guid := c.Param("guid")
	...
	resp, err := services.BuilderService().QueryFolder().Update(
		context.Background(),
		&obs.QueryFolder{
			Id:        guid,
			Title:     queryFolder.Title,
...
// @Response 400 {object} status_http.Response{data=string} "Invalid Argument"
// @Failure 500 {object} status_http.Response{data=string} "Server Error"
func (h *HandlerV1) DeleteQueryFolder(c *gin.Context) {
