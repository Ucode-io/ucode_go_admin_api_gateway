...
func (h *HandlerV3) GetListCustomEvents(request models.GetListCustomEventsStruct, c *gin.Context) (beforeEvents, afterEvents []*obs.CustomEvent, err error) {
	var (
...
func (h *HandlerV3) DoInvokeFuntion(request models.DoInvokeFuntionStruct, c *gin.Context) (functionName string, err error) {
