...
func (h *Handler) V2CreateUser(c *gin.Context) {
	...
	resp, err := services.UserService().V2CreateUser(
		c.Request.Context(),
		&user,
	)
...
func (h *Handler) V2GetUserList(c *gin.Context) {
	...
	resp, err := services.UserService().V2GetUserList(
		c.Request.Context(),
...
func (h *Handler) V2GetUserByID(c *gin.Context) {
	...
	resp, err := services.UserService().V2GetUserByID(
		c.Request.Context(),
...
func (h *Handler) V2UpdateUser(c *gin.Context) {
	...
	resp, err := services.UserService().V2UpdateUser(
		c.Request.Context(),
		&user,
	)
...
func (h *Handler) V2DeleteUser(c *gin.Context) {
	...
	resp, err := services.UserService().V2DeleteUser(
		c.Request.Context(),
		&auth_service.UserPrimaryKey{
			Id: userID,
		},
