...
func Load() Config {
	...
	config.ApiReferenceServiceHost = cast.ToString(GetOrReturnDefaultValue("API_REFERENCE_SERVICE_HOST", "localhost"))
	config.ApiReferenceServicePort = cast.ToString(GetOrReturnDefaultValue("API_REFERENCE_SERVICE_POST", ":8099"))
