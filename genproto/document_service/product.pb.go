...
type ProductsList struct {
	...
	InternationalCode *wrappers.StringValue `protobuf:"bytes,20,opt,name=internationalCode,proto3" json:"internationalCode"`
	BrandName         *wrappers.StringValue `protobuf:"bytes,21,opt,name=brandName,proto3" json:"brandName"`
	AttributeName     *wrappers.StringValue `protobuf:"bytes,22,opt,name=attributeName,proto3" json:"attributeName"`
}
...
type ProductRequest struct {
	...
	InternationalCode *wrappers.StringValue `protobuf:"bytes,20,opt,name=internationalCode,proto3" json:"internationalCode"`
	BrandName         *wrappers.StringValue `protobuf:"bytes,21,opt,name=brand_name,json=brandName,proto3" json:"brand_name"`
	AttributeName     *wrappers.StringValue `protobuf:"bytes,22,opt,name=attribute_name,json=attributeName,proto3" json:"attribute_name"`
}
