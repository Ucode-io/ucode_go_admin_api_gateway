...
type RoleWithAppTablePermissions_App_Table struct {
	...
	AutomaticFilters  []*RoleWithAppTablePermissions_App_Table_AutomaticFilter `protobuf:"bytes,14,rep,name=automatic_filters,json=automaticFilters,proto3" json:"automatic_filters"`
}
