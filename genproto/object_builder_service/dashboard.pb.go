...
const file_dashboard_proto_rawDesc = "" +
	"\n" +
	"\x0fdashboard.proto\x12\x16object_builder_service\x1a\x1bgoogle/protobuf/empty.proto\x1a\vpanel.proto\x1a\x0evariable.proto\"\x9d\x01\n" +
	...
	"\x04icon\x18\x03 \x01(\tR\x04icon\x125\n" +
	"\x06panels\x18\x04 \x03(\v2\x1d.object_builder_service.PanelR\x06panels\x12>\n" +
	"\tvariables\x18\x05 \x03(\v2 .object_builder_service.VariableR\tvariables\x12\x1d\n" +
	"\n" +
	"project_id\x18\x06 \x01(\tR\tprojectId\"r\n" +
	"\x17GetAllDashboadsResponse\x12A\n" +
	"\n" +
	"dashboards\x18\x01 \x03(\v2!.object_builder_service.DashboardR\n" +
	"dashboards\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x05R\x05count\"L\n" +
	"\x17GetAllDashboardsRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\"D\n" +
	"\x13DashboardPrimaryKey\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId2\xd7\x03\n" +
	"\x10DashboardService\x12]\n" +
	"\x06Create\x12..object_builder_service.CreateDashboardRequest\x1a!.object_builder_service.Dashboard\"\x00\x12m\n" +
	"\aGetList\x12/.object_builder_service.GetAllDashboardsRequest\x1a/.object_builder_service.GetAllDashboadsResponse\"\x00\x12]\n" +
	"\tGetSingle\x12+.object_builder_service.DashboardPrimaryKey\x1a!.object_builder_service.Dashboard\"\x00\x12E\n" +
	"\x06Update\x12!.object_builder_service.Dashboard\x1a\x16.google.protobuf.Empty\"\x00\x12O\n" +
	"\x06Delete\x12+.object_builder_service.DashboardPrimaryKey\x1a\x16.google.protobuf.Empty\"\x00B!Z\x1fgenproto/object_builder_serviceb\x06proto3"
