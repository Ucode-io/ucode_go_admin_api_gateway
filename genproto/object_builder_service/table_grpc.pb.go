...
func (c *tableServiceClient) GetFieldsByTable(ctx context.Context, in *GetFieldsByTableReq, opts ...grpc.CallOption) (*GetFieldsByTableRes, error) {
	...
	err := c.cc.Invoke(ctx, "/object_builder_service.TableService/GetFieldsByTable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) GetChart(ctx context.Context, in *ChartPrimaryKey, opts ...grpc.CallOption) (*GetChartResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/object_builder_service.TableService/GetChart", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TableService_GetFieldsByTable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/object_builder_service.TableService/GetFieldsByTable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TableService_GetChart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/object_builder_service.TableService/GetChart",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
