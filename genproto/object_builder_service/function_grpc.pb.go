...
func (c *functionServiceClient) GetListByRequestTime(ctx context.Context, in *GetListByRequestTimeRequest, opts ...grpc.CallOption) (*GetAllFunctionsResponse, error) {
	out := new(GetAllFunctionsResponse)
	err := c.cc.Invoke(ctx, FunctionService_GetListByRequestTime_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *functionServiceClient) UpdateManyByRequestTime(ctx context.Context, in *UpdateManyUrlAndPassword, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, FunctionService_UpdateManyByRequestTime_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *functionServiceClient) GetCountByType(ctx context.Context, in *GetCountByTypeRequest, opts ...grpc.CallOption) (*GetCountByTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, FunctionService_GetCountByType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
