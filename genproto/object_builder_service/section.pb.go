...
const file_section_proto_rawDesc = "" +
	"\n" +
	"\rsection.proto\x12\x16object_builder_service\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\vfield.proto\"\x99\x02\n" +
	"\aSection\x12\x0e\n" +
	...
	"\x06fields\x18\x05 \x03(\v2'.object_builder_service.FieldForSectionR\x06fields\x12\x12\n" +
	...
	"relationId\x12,\n" +
	"\x12view_relation_type\x18\x03 \x01(\tR\x10viewRelationType\"\xf5\x01\n" +
	...
	"viewFields\x12\x1a\n" +
	"\beditable\x18\x06 \x01(\bR\beditable\x12F\n" +
	"\tsummaries\x18\a \x03(\v2(.object_builder_service.SummaryInSectionR\tsummaries\"\x8d\x01\n" +
	...
	"\brelation\x18\x04 \x01(\v2(.object_builder_service.RelationForTableR\brelation\x12\x12\n" +
	...
	"\n" +
	"table_from\x18\x02 \x01(\v2'.object_builder_service.TableForSectionR\ttableFrom\x12B\n" +
	"\btable_to\x18\x03 \x01(\v2'.object_builder_service.TableForSectionR\atableTo\x12\x12\n" +
	"\x04type\x18\x04 \x01(\tR\x04type\x12>\n" +
	"\vview_fields\x18\x05 \x03(\v2\x1d.object_builder_service.FieldR\n" +
	"viewFields\x12F\n" +
	"\tsummaries\x18\x06 \x03(\v2(.object_builder_service.SummaryInSectionR\tsummaries\x12\x1a\n" +
	...
	"\acolumns\x18\n" +
	" \x03(\tR\acolumns\x12R\n" +
	"\rquick_filters\x18\v \x03(\v2-.object_builder_service.QuickFilterForSectionR\fquickFilters\x12!\n" +
	...
	"permission\x12[\n" +
	"\x10action_relations\x18\x11 \x03(\v20.object_builder_service.ActionRelationForSectionR\x0factionRelations\x12#\n" +
	...
	"\rdefault_value\x18\x02 \x01(\tR\fdefaultValue\"\xe8\x02\n" +
	...
	"isOwnTable\x12P\n" +
	"\fincrement_id\x18\n" +
	" \x01(\v2-.object_builder_service.IncrementIDForSectionR\vincrementId\"\x9d\x01\n" +
	"\x0fNewViewRelation\x12\x14\n" +
	"\x05order\x18\x01 \x01(\x05R\x05order\x12F\n" +
	"\brelation\x18\x02 \x01(\v2*.object_builder_service.RelationForSectionR\brelation\x12,\n" +
	"\x12view_relation_type\x18\x03 \x01(\tR\x10viewRelationType\"\x8f\x01\n" +
	"\x17GetViewRelationResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"table_slug\x18\x02 \x01(\tR\ttableSlug\x12E\n" +
	"\trelations\x18\x03 \x03(\v2'.object_builder_service.NewViewRelationR\trelations\"\x80\x01\n" +
	"\x1bGetAllViewRelationsResponse\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x05R\x05count\x12K\n" +
	"\x0eview_relations\x18\x02 \x03(\v2$.object_builder_service.ViewRelationR\rviewRelations\"\xe5\x01\n" +
	"\x17UpsertViewRelationsBody\x12\x1d\n" +
	"\n" +
	"table_slug\x18\x01 \x01(\tR\ttableSlug\x12N\n" +
	"\x0eview_relations\x18\x02 \x03(\v2'.object_builder_service.ViewRelationReqR\rviewRelations\x12\x1d\n" +
	"\n" +
	...
	"\x06column\x18\x03 \x01(\tR\x06column\x12\x14\n" +
	"\x05label\x18\x04 \x01(\tR\x05label\x12=\n" +
	"\x06fields\x18\x05 \x03(\v2%.object_builder_service.FieldResponseR\x06fields\x12\x12\n" +
	"\x04icon\x18\x06 \x01(\tR\x04icon\x12,\n" +
	"\x12is_summary_section\x18\a \x01(\bR\x10isSummarySection\x127\n" +
	"\n" +
	"attributes\x18\b \x01(\v2\x17.google.protobuf.StructR\n" +
	...
	"attributes\x12*\n" +
	"\x11is_visible_layout\x18\b \x01(\bR\x0fisVisibleLayout\"\xcc\x01\n" +
	"\x15UpdateSectionsRequest\x12;\n" +
	"\bsections\x18\x01 \x03(\v2\x1f.object_builder_service.SectionR\bsections\x12\x19\n" +
	...
	"\vcommit_guid\x18\x05 \x01(\tR\n" +
	"commitGuid\"]\n" +
	"\x16GetAllSectionsResponse\x12C\n" +
	"\bsections\x18\x01 \x03(\v2'.object_builder_service.SectionResponseR\bsections\"\xa8\x01\n" +
	...
	"\n" +
	"version_id\x18\x05 \x01(\tR\tversionId2\xa2\x04\n" +
	"\x0eSectionService\x12i\n" +
	"\x06GetAll\x12-.object_builder_service.GetAllSectionsRequest\x1a..object_builder_service.GetAllSectionsResponse\"\x00\x12Q\n" +
	"\x06Update\x12-.object_builder_service.UpdateSectionsRequest\x1a\x16.google.protobuf.Empty\"\x00\x12{\n" +
	"\x13GetAllViewRelations\x12-.object_builder_service.GetAllSectionsRequest\x1a3.object_builder_service.GetAllViewRelationsResponse\"\x00\x12s\n" +
	"\x0fGetViewRelation\x12-.object_builder_service.GetAllSectionsRequest\x1a/.object_builder_service.GetViewRelationResponse\"\x00\x12`\n" +
	"\x13UpsertViewRelations\x12/.object_builder_service.UpsertViewRelationsBody\x1a\x16.google.protobuf.Empty\"\x00B!Z\x1fgenproto/object_builder_serviceb\x06proto3"
