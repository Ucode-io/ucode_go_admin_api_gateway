...
func (c *permissionServiceClient) CreateDefaultPermission(ctx context.Context, in *CreateDefaultPermissionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/object_builder_service.PermissionService/CreateDefaultPermission", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PermissionService_CreateDefaultPermission_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/object_builder_service.PermissionService/CreateDefaultPermission",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
