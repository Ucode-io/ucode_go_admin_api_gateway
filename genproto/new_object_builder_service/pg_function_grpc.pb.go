...
func (UnimplementedFunctionServiceV2Server) GetListByRequestTime(context.Context, *GetListByRequestTimeRequest) (*GetAllFunctionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetListByRequestTime not implemented")
}
func (UnimplementedFunctionServiceV2Server) UpdateManyByRequestTime(context.Context, *UpdateManyUrlAndPassword) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateManyByRequestTime not implemented")
}
func (UnimplementedFunctionServiceV2Server) GetCountByType(context.Context, *GetCountByTypeRequest) (*GetCountByTypeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCountByType not implemented")
}
...
func RegisterFunctionServiceV2Server(s grpc.ServiceRegistrar, srv FunctionServiceV2Server) {
	// If the following call panics, it indicates UnimplementedFunctionServiceV2Server was
