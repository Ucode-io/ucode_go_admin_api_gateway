...
func (UnimplementedLayoutServiceServer) CreateAll(context.Context, *CreateLayoutRequest) (*GetListLayoutResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateAll not implemented")
}
...
func (UnimplementedLayoutServiceServer) GetSingleLayout(context.Context, *GetSingleLayoutRequest) (*LayoutResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSingleLayout not implemented")
}
func (UnimplementedLayoutServiceServer) RemoveLayout(context.Context, *LayoutPrimaryKey) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveLayout not implemented")
}
...
func (UnimplementedLayoutServiceServer) GetLayoutByTableID(context.Context, *GetLayoutByTableIDRequest) (*GetListLayoutResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLayoutByTableID not implemented")
}
