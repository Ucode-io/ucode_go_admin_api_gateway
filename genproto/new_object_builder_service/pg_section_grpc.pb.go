...
func (UnimplementedSectionServiceServer) GetAllViewRelations(context.Context, *GetAllSectionsRequest) (*GetAllViewRelationsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAllViewRelations not implemented")
}
func (UnimplementedSectionServiceServer) GetViewRelation(context.Context, *GetAllSectionsRequest) (*GetViewRelationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetViewRelation not implemented")
}
func (UnimplementedSectionServiceServer) UpsertViewRelations(context.Context, *UpsertViewRelationsBody) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertViewRelations not implemented")
}
