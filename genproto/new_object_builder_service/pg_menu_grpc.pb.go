...
func (c *menuServiceClient) GetByLabel(ctx context.Context, in *MenuPrimaryKey, opts ...grpc.CallOption) (*GetAllMenusResponse, error) {
	...
	err := c.cc.Invoke(ctx, MenuService_GetByLabel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuServiceClient) GetMenuTree(ctx context.Context, in *MenuPrimaryKey, opts ...grpc.CallOption) (*MenuTree, error) {
	out := new(MenuTree)
	err := c.cc.Invoke(ctx, MenuService_GetMenuTree_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuServiceClient) GetMenuTemplateWithEntities(ctx context.Context, in *GetMenuTemplateRequest, opts ...grpc.CallOption) (*MenuTemplateWithEntities, error) {
	...
	err := c.cc.Invoke(ctx, MenuService_GetMenuTemplateWithEntities_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
