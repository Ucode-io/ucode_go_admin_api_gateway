...
func (c *menuServiceClient) GetByLabel(ctx context.Context, in *MenuPrimaryKey, opts ...grpc.CallOption) (*GetAllMenusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.MenuService/GetByLabel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *menuServiceClient) GetMenuTemplateWithEntities(ctx context.Context, in *GetMenuTemplateRequest, opts ...grpc.CallOption) (*MenuTemplateWithEntities, error) {
	...
	err := c.cc.Invoke(ctx, "/new_object_builder_service.MenuService/GetMenuTemplateWithEntities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MenuService_GetByLabel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.MenuService/GetByLabel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _MenuService_GetMenuTemplateWithEntities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/new_object_builder_service.MenuService/GetMenuTemplateWithEntities",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
