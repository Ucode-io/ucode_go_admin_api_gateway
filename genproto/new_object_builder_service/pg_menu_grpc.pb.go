...
func (UnimplementedMenuServiceServer) GetByLabel(context.Context, *MenuPrimaryKey) (*GetAllMenusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetByLabel not implemented")
}
...
func (UnimplementedMenuServiceServer) UpdateMenuOrder(context.Context, *UpdateMenuOrderRequest) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateMenuOrder not implemented")
}
...
func (UnimplementedMenuServiceServer) CreateMenuSettings(context.Context, *CreateMenuSettingsRequest) (*MenuSettings, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMenuSettings not implemented")
}
...
func (UnimplementedMenuServiceServer) GetMenuTemplateWithEntities(context.Context, *GetMenuTemplateRequest) (*MenuTemplateWithEntities, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMenuTemplateWithEntities not implemented")
}
