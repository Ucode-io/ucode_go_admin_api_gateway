...
func (UnimplementedViewServiceServer) ConvertHtmlToPdf(context.Context, *HtmlBody) (*PdfBody, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertHtmlToPdf not implemented")
}
func (UnimplementedViewServiceServer) ConvertTemplateToHtml(context.Context, *HtmlBody) (*HtmlBody, error) {
	return nil, status.Error(codes.Unimplemented, "method ConvertTemplateToHtml not implemented")
}
func (UnimplementedViewServiceServer) UpdateViewOrder(context.Context, *UpdateViewOrderRequest) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateViewOrder not implemented")
}
