...
func (c *relationServiceClient) GetIds(ctx context.Context, in *GetIdsReq, opts ...grpc.CallOption) (*GetIdsResp, error) {
	out := new(GetIdsResp)
	err := c.cc.Invoke(ctx, RelationService_GetIds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationServiceClient) GetRelationsByTableFrom(ctx context.Context, in *GetRelationsByTableFromRequest, opts ...grpc.CallOption) (*GetRelationsByTableFromResponse, error) {
	...
	err := c.cc.Invoke(ctx, RelationService_GetRelationsByTableFrom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
