...
type FacturaProducts struct {
	...
	LgotaId                *wrappers.Int32Value `protobuf:"bytes,25,opt,name=LgotaId,proto3" json:"LgotaId"`
	CommittentVatRegStatus *wrappers.Int32Value `protobuf:"bytes,26,opt,name=CommittentVatRegStatus,proto3" json:"CommittentVatRegStatus"`
