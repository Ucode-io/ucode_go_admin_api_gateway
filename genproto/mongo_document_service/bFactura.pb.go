...
type Client struct {
	...
	VatRegStatus *wrappers.Int32Value `protobuf:"bytes,12,opt,name=VatRegStatus,proto3" json:"VatRegStatus"`
	...
	TaxGap       *wrappers.FloatValue `protobuf:"bytes,15,opt,name=TaxGap,proto3" json:"TaxGap"`
}
