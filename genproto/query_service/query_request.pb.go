...
type Query struct {
	...
	ProjectResourceId string           `protobuf:"bytes,15,opt,name=project_resource_id,json=projectResourceId,proto3" json:"project_resource_id"`
...
type CreateQueryReq struct {
	...
	ProjectResourceId string           `protobuf:"bytes,14,opt,name=project_resource_id,json=projectResourceId,proto3" json:"project_resource_id"`
}
