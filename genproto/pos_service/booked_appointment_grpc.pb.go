...
func (c *bookedAppointmentServiceClient) GetList(ctx context.Context, in *GetAllBookedAppointmentsRequest, opts ...grpc.CallOption) (*GetAllBookedAppointmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookedAppointmentService_GetList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookedAppointmentServiceClient) GetSingle(ctx context.Context, in *BookedAppointmentPrimaryKey, opts ...grpc.CallOption) (*GetSingleBookedAppointmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, BookedAppointmentService_GetSingle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBookedAppointmentServiceServer must be embedded to have
...
func (UnimplementedBookedAppointmentServiceServer) testEmbeddedByValue() {}
...
func RegisterBookedAppointmentServiceServer(s grpc.ServiceRegistrar, srv BookedAppointmentServiceServer) {
	// If the following call pancis, it indicates UnimplementedBookedAppointmentServiceServer was
