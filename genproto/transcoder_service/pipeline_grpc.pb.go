...
func (c *pipelineServiceClient) Create(ctx context.Context, in *CreatePipelineRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, PipelineService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) GetList(ctx context.Context, in *GetListPipelineRequest, opts ...grpc.CallOption) (*GetListPipelineResponse, error) {
	...
	err := c.cc.Invoke(ctx, PipelineService_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pipelineServiceClient) CreateCompanyAndProject(ctx context.Context, in *CreateCompanyAndProjectRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, PipelineService_CreateCompanyAndProject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
