...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\fauth_service\x1a\x1cgoogle/protobuf/struct.proto\"q\n" +
	"\x0eClientPlatform\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x1c\n" +
	"\tsubdomain\x18\x04 \x01(\tR\tsubdomain\"\xcc\x02\n" +
	"\n" +
	"ClientType\x12\x0e\n" +
	...
	"\x06tables\x18\a \x03(\v2\x13.auth_service.TableR\x06tables\x12!\n" +
	"\fdefault_page\x18\b \x01(\tR\vdefaultPage\x12#\n" +
	"\rsession_limit\x18\t \x01(\x05R\fsessionLimit\"\xa7\x01\n" +
	"\bRelation\x12\x0e\n" +
	...
	"\tdata_type\x18\x05 \x01(\tR\bdataType\"\xc1\x01\n" +
	"\x06Client\x12,\n" +
	"\x12client_platform_id\x18\x01 \x01(\tR\x10clientPlatformId\x12$\n" +
	"\x0eclient_type_id\x18\x02 \x01(\tR\fclientTypeId\x12D\n" +
	"\x0elogin_strategy\x18\x03 \x01(\x0e2\x1d.auth_service.LoginStrategiesR\rloginStrategy\x12\x1d\n" +
	"\n" +
	"project_id\x18\x04 \x01(\tR\tprojectId\"\x9d\x01\n" +
	"\x04Role\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12$\n" +
	...
	"\brequests\x18\x04 \x01(\x03R\brequests\"{\n" +
	"\n" +
	"Permission\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12,\n" +
	...
	"\x06method\x18\x04 \x01(\tR\x06method\"N\n" +
	"\x0eRolePermission\x12\x17\n" +
	"\arole_id\x18\x01 \x01(\tR\x06roleId\x12#\n" +
	"\rpermission_id\x18\x02 \x01(\tR\fpermissionId\"\xb6\x04\n" +
	"\x04User\x12\x0e\n" +
	...
	"\tphoto_url\x18\a \x01(\tR\bphotoUrl\x12\x1d\n" +
	"\n" +
	"company_id\x18\b \x01(\tR\tcompanyId\x12\x1d\n" +
	"\n" +
	"project_id\x18\t \x01(\tR\tprojectId\x12\x17\n" +
	"\arole_id\x18\n" +
	" \x01(\tR\x06roleId\x12$\n" +
	"\x0eclient_type_id\x18\v \x01(\tR\fclientTypeId\x12,\n" +
	"\x12client_platform_id\x18\f \x01(\tR\x10clientPlatformId\x12\x16\n" +
	"\x06active\x18\r \x01(\x05R\x06active\x12\x1d\n" +
	"\n" +
	"expires_at\x18\x0e \x01(\tR\texpiresAt\x122\n" +
	"\blanguage\x18\x0f \x01(\v2\x16.auth_service.LanguageR\blanguage\x122\n" +
	"\btimezone\x18\x10 \x01(\v2\x16.auth_service.TimezoneR\btimezone\x12\x1b\n" +
	"\thash_type\x18\x11 \x01(\tR\bhashType\x12\x16\n" +
	"\x06status\x18\x12 \x01(\tR\x06status\x12\x10\n" +
	"\x03tin\x18\x13 \x01(\tR\x03tin\"B\n" +
	"\bTimezone\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"nativeName\"H\n" +
	"\fUserRelation\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1f\n" +
	"\vrelation_id\x18\x02 \x01(\tR\n" +
	"relationId\"P\n" +
	"\bUserInfo\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12+\n" +
	"\x04data\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x04data\"\xdb\x03\n" +
	"\aSession\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	...
	"\x0eintegration_id\x18\f \x01(\tR\rintegrationId\x12\x1d\n" +
	"\n" +
	"is_changed\x18\r \x01(\bR\tisChanged\x12\x15\n" +
	"\x06env_id\x18\x0e \x01(\tR\x05envId\x12 \n" +
	"\fuser_id_auth\x18\x0f \x01(\tR\n" +
	"userIdAuth\x12\x1b\n" +
	"\tclient_id\x18\x10 \x01(\tR\bclientId\"\xba\x02\n" +
	"\bPasscode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	"project_id\x18\x02 \x01(\tR\tprojectId\x12,\n" +
	...
	"\vhashed_code\x18\a \x01(\tR\n" +
	"hashedCode\x12\x14\n" +
	"\x05state\x18\b \x01(\x05R\x05state\x12\x1d\n" +
	"\n" +
	"expires_at\x18\t \x01(\tR\texpiresAt\x12\x1d\n" +
	"\n" +
	"created_at\x18\n" +
	...
	"\x12refresh_in_seconds\x18\x06 \x01(\x05R\x10refreshInSeconds\"\x8a\x03\n" +
	...
	"\x06active\x18\b \x01(\x05R\x06active\x12\x1d\n" +
	"\n" +
	"expires_at\x18\t \x01(\tR\texpiresAt\x12\x1d\n" +
	"\n" +
	"created_at\x18\n" +
	...
	"\x04data\x18\r \x01(\tR\x04data\"\xae\x01\n" +
	"\x05Table\x12\x12\n" +
	...
	"\n" +
	"view_label\x18\x06 \x01(\tR\tviewLabel\"\xa2\x01\n" +
	"\aProject\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1d\n" +
	"\n" +
	...
	"\x0fLoginStrategies\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\f\n" +
	"\bSTANDARD\x10\x01\x12\r\n" +
	"\tPHONE_OTP\x10\x02\x12\r\n" +
	"\tEMAIL_OTP\x10\x03*8\n" +
	"\x11ConfirmStrategies\x12\r\n" +
	"\tUNDECIDED\x10\x00\x12\t\n" +
	"\x05PHONE\x10\x01\x12\t\n" +
	"\x05EMAIL\x10\x02*7\n" +
	"\rRelationTypes\x12\x0e\n" +
	"\n" +
	"UNREVEALED\x10\x00\x12\n" +
	"\n" +
	"\x06BRANCH\x10\x01\x12\n" +
	"\n" +
	"\x06REGION\x10\x02B\x17Z\x15genproto/auth_serviceb\x06proto3"
