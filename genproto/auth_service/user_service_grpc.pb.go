...
func (UnimplementedUserServiceServer) GetUserListByIDs(context.Context, *UserPrimaryKeyList) (*GetUserListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserListByIDs not implemented")
}
...
func (UnimplementedUserServiceServer) GetProjectsByUserId(context.Context, *GetProjectsByUserIdReq) (*GetProjectsByUserIdRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProjectsByUserId not implemented")
}
func (UnimplementedUserServiceServer) V2GetUserByLoginTypes(context.Context, *GetUserByLoginTypesRequest) (*GetUserByLoginTypesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method V2GetUserByLoginTypes not implemented")
}
func (UnimplementedUserServiceServer) RegisterUserViaEmail(context.Context, *CreateUserRequest) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterUserViaEmail not implemented")
}
func (UnimplementedUserServiceServer) RegisterWithGoogle(context.Context, *RegisterWithGoogleRequest) (*User, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterWithGoogle not implemented")
}
func (UnimplementedUserServiceServer) GetListSetting(context.Context, *GetListSettingReq) (*Setting, error) {
	return nil, status.Error(codes.Unimplemented, "method GetListSetting not implemented")
}
...
func (UnimplementedUserServiceServer) GetUserProjectClientTypes(context.Context, *UserInfoPrimaryKey) (*GetUserProjectClientTypesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserProjectClientTypes not implemented")
}
