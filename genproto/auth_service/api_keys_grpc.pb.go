...
func (UnimplementedApiKeysServer) GenerateApiToken(context.Context, *GenerateApiTokenReq) (*GenerateApiTokenRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateApiToken not implemented")
}
func (UnimplementedApiKeysServer) RefreshApiToken(context.Context, *RefreshApiTokenReq) (*RefreshApiTokenRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshApiToken not implemented")
}
func (UnimplementedApiKeysServer) GetEnvID(context.Context, *GetReq) (*GetRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEnvID not implemented")
}
func (UnimplementedApiKeysServer) ListClientToken(context.Context, *ListClientTokenRequest) (*ListClientTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListClientToken not implemented")
}
