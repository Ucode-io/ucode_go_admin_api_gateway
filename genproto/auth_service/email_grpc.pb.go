...
func (UnimplementedEmailOtpServiceServer) CreateEmailSettings(context.Context, *EmailSettings) (*EmailSettings, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateEmailSettings not implemented")
}
func (UnimplementedEmailOtpServiceServer) UpdateEmailSettings(context.Context, *UpdateEmailSettingsRequest) (*EmailSettings, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateEmailSettings not implemented")
}
func (UnimplementedEmailOtpServiceServer) GetListEmailSettings(context.Context, *GetListEmailSettingsRequest) (*UpdateEmailSettingsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetListEmailSettings not implemented")
}
func (UnimplementedEmailOtpServiceServer) DeleteEmailSettings(context.Context, *EmailSettingsPrimaryKey) (*empty.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteEmailSettings not implemented")
}
...
func RegisterEmailOtpServiceServer(s grpc.ServiceRegistrar, srv EmailOtpServiceServer) {
	// If the following call panics, it indicates UnimplementedEmailOtpServiceServer was
