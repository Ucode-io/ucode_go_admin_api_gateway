...
func (UnimplementedCompanyServiceServer) GetListWithProjects(context.Context, *GetListWithProjectsRequest) (*GetListWithProjectsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetListWithProjects not implemented")
}
func (UnimplementedCompanyServiceServer) GetCompaniesByOwnerId(context.Context, *GetCompaniesByOwnerIdReq) (*GetCompaniesByOwnerIdRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCompaniesByOwnerId not implemented")
}
...
func (UnimplementedCompanyServiceServer) GetMenuTemplateById(context.Context, *GetMenuTemplateRequest) (*MenuTemplate, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMenuTemplateById not implemented")
}
...
func (UnimplementedCompanyServiceServer) GetProjectMenuTemplates(context.Context, *GetProjectMenuTemplateRequest) (*GetProjectMenuTemplateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProjectMenuTemplates not implemented")
}
func (UnimplementedCompanyServiceServer) CreateMenuTemplateByTemplateId(context.Context, *CreateMenuTemplateByTemplateIdRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMenuTemplateByTemplateId not implemented")
}
