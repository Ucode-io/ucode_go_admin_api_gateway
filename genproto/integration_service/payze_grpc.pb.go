...
type PayzeServiceClient interface {
	...
	GeneratePayzeLinkSvod(ctx context.Context, in *PayzeLinkRequestSvod, opts ...grpc.CallOption) (*PayzeLinkResponseSvod, error)
...
func (c *payzeServiceClient) GeneratePayzeLinkSvod(ctx context.Context, in *PayzeLinkRequestSvod, opts ...grpc.CallOption) (*PayzeLinkResponseSvod, error) {
	out := new(PayzeLinkResponseSvod)
...
type PayzeServiceServer interface {
	...
	GeneratePayzeLinkSvod(context.Context, *PayzeLinkRequestSvod) (*PayzeLinkResponseSvod, error)
...
func (UnimplementedPayzeServiceServer) GeneratePayzeLinkSvod(context.Context, *PayzeLinkRequestSvod) (*PayzeLinkResponseSvod, error) {
