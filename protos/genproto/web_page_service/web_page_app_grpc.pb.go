...
type AppServiceClient interface {
	...
	DeleteApp(ctx context.Context, in *DeleteAppReq, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *appServiceClient) DeleteApp(ctx context.Context, in *DeleteAppReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type AppServiceServer interface {
	...
	DeleteApp(context.Context, *DeleteAppReq) (*empty.Empty, error)
...
func (UnimplementedAppServiceServer) DeleteApp(context.Context, *DeleteAppReq) (*empty.Empty, error) {
